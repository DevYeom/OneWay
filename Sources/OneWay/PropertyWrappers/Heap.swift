...
/// When applied to a property of `State`, the corresponding value will always be heap-allocated.
/// This happens because this wrapper is a class and classes are always heap-allocated.
///
/// Use of this wrapper is required on large value types because they can overflow the Swift runtime
/// stack.
///
