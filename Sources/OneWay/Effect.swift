...
/// provide data to the ``Store``. This is the perfect place to handle side effects, including
/// network requests, saving/loading from disk, creating timers, interacting with dependencies, and
/// more.
///
